...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.zx-collapse-item__header')
    contents = wrapper.findAll('.zx-collapse-item__wrapper')
  ...
  test('测试基础结构以及对应文本', () => {
    ...
    expect(firstContent.text()).toBe('this is content a')
  })
  ...
  test('disabled 的内容应该没有反应', async () => {
    ...
    await disabledContent.trigger('click')
